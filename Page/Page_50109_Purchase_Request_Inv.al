page 50109 "Purchase Request Invoice"
{
    Caption = 'Purchase Requests (Ready to Create Purchase Invoice)';
    PageType = List;
    ApplicationArea = All;
    UsageCategory = Lists;
    SourceTable = "Purchase Requisition Line";
    SourceTableView = where("Ready for PO" = const(true), "Purchase Doc Created" = const(false), "Transaction Type" = const(Invoice), Cancelled = const(false));
    InsertAllowed = false;
    DeleteAllowed = false;
    layout
    {
    ...
    begin
        ...
        "Date Created" := RequestHdr."Date of Request"; //Added by Cedric Dominique - 04.06.2021 
    ...
    var
        ...
        FileCodeunit: Codeunit "File Management";
        TempBlob_lRec: Record TempBlob;
        Convert: DotNet Convert;
        FileContent: BigText;
        FileMgt: File;
        InStreamVar: InStream;
        InStreamVar1: InStream;
