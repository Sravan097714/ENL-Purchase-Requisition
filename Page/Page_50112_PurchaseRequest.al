page 50112 "Purchase Request"
{
    Caption = 'Purchase Requests (Cancelled)';
    PageType = List;
    ApplicationArea = All;
    UsageCategory = Lists;
    SourceTable = "Purchase Requisition Line";
    SourceTableView = where("Ready for PO" = const(true), "Purchase Doc Created" = const(false), Cancelled = const(true));
    InsertAllowed = false;
    DeleteAllowed = false;
    layout
    {
