page 50108 "Purch. Requests (Inv. Created)"
{
    Caption = 'Purchase Requests (Invoice Created)';
    PageType = List;
    ApplicationArea = All;
    UsageCategory = Lists;
    Editable = false;
    ...
    SourceTableView = where("Ready for PO" = const(true), "Purchase Doc Created" = const(true), "Transaction Type" = const(Invoice));
    layout
    {
        area(Content)
        {
