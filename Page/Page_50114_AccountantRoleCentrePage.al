page 50114 "Accountant Role Center Page"
{
    ...
    layout
    {
        area(rolecenter)
        {
            ...
            part("Purchase Orders Pending Approval"; "PurchaseOrdersPending Approval")
            {
                ApplicationArea = all;
            }
            part(vendorpayment; "VendorPayment Approval Cue") { ApplicationArea = all; }
